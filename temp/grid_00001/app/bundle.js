...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcH5Form = __webpack_require__(157);

	var _srcH5Form2 = _interopRequireDefault(_srcH5Form);

	var _srcH5Row = __webpack_require__(163);

	var _srcH5Row2 = _interopRequireDefault(_srcH5Row);

	var _srcH5Input = __webpack_require__(164);

	var _srcH5Input2 = _interopRequireDefault(_srcH5Input);
	...
	var ViewGrid = _react2['default'].createClass({
	    displayName: 'ViewGrid',

	    render: function render() {
	        return _react2['default'].createElement(_srcH5Form2['default'], { labelText: { pt_br: "grid" } }, [_react2['default'].createElement(_srcH5Row2['default'], {}, [_react2['default'].createElement(_srcH5Input2['default'], {
	            store: mock_store,
	            field: 'campo',
	            rowSpan: [1],
	            colSpan: [1]
	        })]), _react2['default'].createElement(_srcH5Row2['default'], {}, [_react2['default'].createElement(_srcH5Input2['default'], {
	            store: mock_store,
	            field: 'campo',
	            rowSpan: [1],
	            colSpan: [1]
	        }), _react2['default'].createElement(_srcH5Input2['default'], {
	            store: mock_store,
	            field: 'campo',
	            rowSpan: [1],
	            colSpan: [1]
	...
	_react2['default'].render(_react2['default'].createElement(ViewGrid, null), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var h5mixinprops = __webpack_require__(162);
	...
	var hform = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement('table', { width: "100%", cellSpacing: "10px", cellPadding: 0 }, [this.props.children]);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ".h_input {\n  position: relative;\n  width: 100%;\n  height: 30px;\n  border: none;\n  outline: none;\n  background-color: transparent;\n  color: rgba(0, 0, 0, 0.87);\n  font: inherit;\n  box-sizing: border-box;\n  margin-top: 33px;\n  z-index: 20;\n}\n.h_input_td {\n  position: relative;\n  height: 72px;\n}\n.h_Input_LabelSemValue {\n  position: absolute;\n  line-height: 22px;\n  opacity: 1;\n  color: rgba(0, 0, 0, 0.298039);\n  top: 41px;\n}\n.h_Input_LabelComValue {\n  position: absolute;\n  line-height: 22px;\n  opacity: 1;\n  color: rgba(0, 0, 0, 0.298039);\n  top: 25px;\n  font-size: 14px;\n}\n.erro {\n  color: red !important;\n}\n.focus {\n  color: #00bcd4 !important;\n}\n.h_input_hr {\n  border: none;\n  border-bottom: solid 1px #e0e0e0;\n  position: absolute;\n  width: 100%;\n  bottom: 8px;\n  margin: 0;\n  box-sizing: content-box;\n  height: 0;\n}\n.h_input_hr_error {\n  border-bottom: solid 1px red !important;\n}\n.h_input_hr_focus {\n  border-style: none none solid;\n  border-bottom-width: 2px;\n  position: absolute;\n  width: 100%;\n  bottom: 8px;\n  margin: 0px;\n  box-sizing: content-box;\n  height: 0px;\n  border-color: #00bcd4;\n  transform: scaleX(1);\n}\n.h_input_hr_focus_error {\n  border-bottom: solid 2px red !important;\n}\n.h_input_labelError {\n  color: red;\n  font-size: 10px;\n  bottom: -10px;\n  position: absolute;\n  left: 0px;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	var h5MixinProps = {
	    getProps: function getProps(props) {
	        var propriedades;
	        if (props) propriedades = props;else propriedades = this.props;

	        var props_button = {};

	        for (var prop in propriedades) {
	            if (/.+Text$/.test(prop)) {
	                if (typeof propriedades[prop] === "object") props_button[prop] = propriedades[prop][window.hsession.language];else props_button[prop] = propriedades[prop];
	            } else props_button[prop] = propriedades[prop];
	        }

	        return props_button;
	    },
	    getPropsArray: function getPropsArray(propComponent) {
	        var self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HInput = React.createClass({
	    ...
	    render: function render() {
	        ...
	        if (field.validations && field.validations.length) propsInput.onBlur = this.blurHandler;else if (this.props.field == 'cpf') propsInput.onBlur = this.cpf;
	        ...
	        var classNameLabel = this.state.focused || propsInput.value || propsInput.value != '' ? 'h_Input_LabelComValue ' + (this.state.focused ? propsInput.errorText ? 'erro' : 'focus' : propsInput.errorText ? 'erro' : '') : 'h_Input_LabelSemValue ' + (propsInput.errorText ? 'erro' : '');

	        return React.createElement('td', propstd, [React.createElement('label', {
	            className: classNameLabel
	        }, [field.labelText]), !propsInput.value && this.state.focused || propsInput.value == '' && this.state.focused ? React.createElement('label', {
	            className: 'h_Input_LabelSemValue ' + (propsInput.errorText ? 'erro' : '')
	        }, [field.hintText]) : null, React.createElement('input', propsInput), React.createElement('hr', {
	        ...
	        }) : null, propsInput.errorText ? React.createElement('span', {
	    ...
	    cpf: function cpf(ev) {
	        ...
	        var ret;
	        soma = 0;
	        if (value.length != 11 || value == "00000000000" || value == "11111111111" || value == "22222222222" || value == "33333333333" || value == "44444444444" || value == "55555555555" || value == "66666666666" || value == "77777777777" || value == "88888888888" || value == "99999999999") return this.props.store.fields.cpf.error = 'cpf invalido';
	        for (var i = 1; i <= 9; i++) soma = soma + parseInt(value.substring(i - 1, i)) * (11 - i);
	        resto = soma * 10 % 11;
	        if (resto == 10 || resto == 11) resto = 0;
	        if (resto != parseInt(value.substring(9, 10))) return this.props.store.fields.cpf.error = 'cpf invalido';
	        soma = 0;
	        for (var i = 1; i <= 10; i++) soma = soma + parseInt(value.substring(i - 1, i)) * (12 - i);
	        resto = soma * 10 % 11;
	        if (resto == 10 || resto == 11) resto = 0;
	        if (resto != parseInt(value.substring(10, 11))) return this.props.store.fields.cpf.error = 'cpf invalido';
